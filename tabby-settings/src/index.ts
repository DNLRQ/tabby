...
import TabbyCorePlugin, { ToolbarButtonProvider, HotkeyProvider, ConfigProvider, HotkeysService, AppService, CommandProvider } from 'tabby-core'
...
@NgModule({
    ...
    providers: [
        ...
        { provide: CommandProvider, useClass: SettingsCommandProvider, multi: true },
